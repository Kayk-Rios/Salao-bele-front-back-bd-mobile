...
export default function Logo() {
    return (
        <Link href="/" className="flex items-center h-14">
            <Image src="/logo.jpeg" alt="Logo" width={65} height={65} className="hidden sm:block rounded-full" />
            <Image src="/logo.jpeg" alt="Logo" width={50} height={50} className="block sm:hidden  rounded-full" />
